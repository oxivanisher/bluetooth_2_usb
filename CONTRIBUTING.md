...
- target host type
- whether `bluetooth_2_usb smoketest --verbose` passed or failed, without
  pasting its raw output
- the Markdown report generated by `bluetooth_2_usb debug --duration 10`
